...
_FARM_SPECS: List[FarmSpec] = [
    FarmSpec("Kisvarsany", 271_000),
    FarmSpec("Gavavencsello", 271_000),
    FarmSpec("Foldes", 271_000),
    FarmSpec("Kaba", 271_000),
    FarmSpec("Nyiribrony", 271_000),
    FarmSpec("Aranyosapati", 271_000),
    FarmSpec("Blhaza_VI", 271_000),
    FarmSpec("Blhaza_III", 271_000),
    FarmSpec("Blhaza_II", 271_000),
    FarmSpec("Blhaza_I", 271_000),
    FarmSpec("Blhaza_V", 271_000),
    FarmSpec("IstvanMajor_B_IV", 271_000),
    FarmSpec("Levelek_I", 271_000),
    FarmSpec("Levelek_II", 271_000),
    FarmSpec("Nyirmada", 271_000),
    FarmSpec("Hodmezovasarhely_Nanas", 271_000),
    FarmSpec("Tiszakarad", 271_000),
    FarmSpec("Sarospatak", 271_000),
    FarmSpec("Pusztadobos", 271_000),
    FarmSpec("Laskod", 271_000),
    FarmSpec("Ibrany", 271_000),
    FarmSpec("Petnehaza_I", 271_000),
    FarmSpec("Petnehaza_II", 271_000),
    FarmSpec("Fabianhaza", 271_000),
    FarmSpec("Nyirkarasz_I", 271_000),
    FarmSpec("Nyirkercs_I", 271_000),
    FarmSpec("Cigand_I", 271_000),
    FarmSpec("Nyirkercs_II", 271_000),
    FarmSpec("Vojka_Farm_Veke", 271_000),
    FarmSpec("Nyirkercs_III", 271_000),
    FarmSpec("Eperjeske", 271_000),
    FarmSpec("Nagyhalasz", 271_000),
    FarmSpec("Nagyecsed", 271_000),
    FarmSpec("Beregdaroc", 271_000),
    FarmSpec("Cigand_II", 271_000),
    FarmSpec("Kantorjanosi", 271_000),
]
